...
function Product() {
  ...
  return (
    <div className={classes.box}>
        ...
        {(!showDetail&&showAll)&&<ProductItem onClick={onDetailHandler} onClick2={clickItemHandler}/>}
        {(!showDetail&&onSale)&&<SaleProduct/>}
        {(!showDetail&&featured)&&<Feature/>}
        {showDetail&&<Detail onBack={backHandler} itemsToBeDisplayed={itemsToBeDisplayed}/>}
    </div>
  )
}
